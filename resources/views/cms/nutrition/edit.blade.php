                    ...
                    <div class="card card-primary">
                        ...
                        <form id="create-form">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name"
                                        value="{{ $nutrition->name }}" placeholder="{{ __('cms.name') }}">
                                </div>
                                <div class="form-group">
                                    <label for="description">{{ __('cms.description') }}</label>
                                    <input type="text" class="form-control" id="description" name="description"
                                        value="{{ $nutrition->description }}" placeholder="{{ __('cms.description') }}">
                                </div>
                            </div>
                            <!-- /.card-body -->
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{ route('nutritions.index') }}" class="btn btn-secondary float-right">cancel</a>
                            </div>
                        </form>
                    </div>
                    <!-- /.card -->
